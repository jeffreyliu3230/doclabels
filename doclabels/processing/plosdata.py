...
from doclabels.helpers import compose
...
logging.basicConfig(filename='log/plosdata.log', level=logging.DEBUG)
...
def process_sources(file_list, pad=False):
    """
    Combine all preprocessing steps here.
    cleaning, add response. Add padding if pad is set to True.
    """
    docs = []
    responses = []
...
# For Convoluntional Neural Networks
